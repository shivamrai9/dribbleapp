...
const SignupForm = () => {
    ...
    async function registerUser(register) {
        ...
        try{
            setLoging(true);
            reset();
            let res = await axios.post('http://localhost:8000/auth/register', register)
            console.log(res)
            if(res.status === 201){
                navigate('/profile');
            }else{
            ...
            {action.signup === 'signup' ?                
                <div className="bg-white flex justify-center items-center h-screen ">
                    ...
                    <div className=" w-full lg:w-3/5 h-full flex flex-col p-8  ">
                        <p className="text-center lg:text-right font-bold mb-1 md:mb-10">Already a member?<span className='text-violet-600 hover:underline cursor-pointer' onClick={() => { navigate('/signin') }}> Sign In</span></p>
                ...
                <div>
                    <div className="max-w-md m-auto rounded-xl p-6 shadow-lg bg-white">
                        ...
                        <div className="text-gray-800 text-md text-center mt-2">
                            ...
                            <span onClick={() => { navigate('/signup') }} className="text-blue-400 font-bold hover:underline cursor-pointer">
                                Sign up
                            </span>
                        </div>
                        <div className="mt-8">
                            ...
                            <input name="email" type="text" className="transition-colors w-full rounded-md h-10 border indent-2 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500" />
                        </div>
                        <div className="mt-4">
